...
return array(
  ...
  'remindPassword'              => array(
    ...
    'success'                   => 'На указанный e-mail отправлено письмо с инструкцией по восстановлению пароля',
    'mailSubject'               => 'Инструкция по восстановлению пароля',
    'mailText'                  => 'Для сброса пароля, пожалуйста, проследуйте по :url',
    'mailLink'                  => 'ссылке',
  ),
  'resetPassword'               => array(
    'title'                     => 'Сброс пароля',
    'fail'                      => 'Просроченный код сброса пароля',
